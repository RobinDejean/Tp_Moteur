...
public: 
	...
	static glm::vec3 projectVectorOnPlan(glm::vec3 _vector, glm::vec3 _planNormal);
	static float clipAngle180(float _angle);
	static void cameraUpdate(float m_eulerAngle, float m_rotationSpeed, double speed);
